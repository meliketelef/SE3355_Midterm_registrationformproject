document.addEventListener("DOMContentLoaded", function () {
    ...
    function validatePhoneNumber(areaCode, phone) {
        const cleanedPhone = phone.replace(/\s+/g, ''); 
        const phonePattern = /^\d{7}$/; 
        const validAreaCodes = Object.values(turkeyAreaCodes);

        return validAreaCodes.includes(areaCode) && phonePattern.test(cleanedPhone);
    }
